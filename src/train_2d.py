...
def main(args):
    ...
    loss_checkpoint_callback = ModelCheckpoint(
            ...
            filename=f'MODEL_{model_name}_{in_channels}_' + f"SEED2D_{seed}_BASELINE_{baseline}_{attribute}_LOSS",
    ...
    f1_checkpoint_callback = ModelCheckpoint(
            ...
            mode="max",
            save_top_k=1, # final runs
            filename=f'MODEL_{model_name}_{in_channels}_' + f"SEED2D_{seed}_BASELINE_{baseline}_{attribute}_F1" ,
            save_weights_only=False,
            dirpath=SAVEDIR,
    )
    ...
    final_path = os.path.join(SAVEDIR, f"MODEL_{model_name}_{in_channels}_final_model_SEED2D_{seed}_BASELINE_{baseline}_{attribute}.ckpt")
